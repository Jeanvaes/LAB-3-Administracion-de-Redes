...
Como se ha expresado con anterioridad, parte de la topología es IPv6 lo cual cambia levemente la configuración en los routers y switches, y además cambia la forma de asignación de IPs. Es por eso que es necesario tomar las decisiones correctas en cuanto que protocolos usar para los requisitos de red dados, es así que, como se expresó y explicó con antelación, para las intranets se hizo uso de Stateless DHCP configurado internamente en los routers R1_BOG y R2_MAD, también se generan las ips a través de EUI-64 y por ultimo, son estos mismos routers quienes dan a los nodos terminales los datos de Gateway y prefijo de red. La configuración en el router R1_BOG se muestra a continuación y es replicable para la R2_MAD:
